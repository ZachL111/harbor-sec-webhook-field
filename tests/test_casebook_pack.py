"""Regression checks for the harbor-sec-webhook-field casebook."""
...
from casebook.harness import assert_expected, harbor_sec_webhook_field_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(harbor_sec_webhook_field_summary(), assert_expected())
